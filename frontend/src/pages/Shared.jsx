...
import { Search, Share2, Users, Link2, LayoutGrid, List } from 'lucide-react';
            ...
            <main className="flex-1 ml-64 mr-80">
                ...
                <div className="p-8">
                    <div className="flex items-center justify-between mb-6">
                        <div>
                            <h2 className="text-2xl font-bold mb-1">Shared Files</h2>
                            <p className="text-zinc-500 text-sm">Files you've shared with others</p>
                        </div>
                    ...
                    {filteredMedia.length === 0 ? (
                        <div className="py-20 flex flex-col items-center justify-center border-2 border-dashed border-zinc-800 rounded-3xl">
                            ...
                            <h3 className="text-lg font-semibold text-zinc-300">No shared files</h3>
                            <p className="text-zinc-500 text-sm">Share your first file to see it here.</p>
                        </div>
                    ) : (
