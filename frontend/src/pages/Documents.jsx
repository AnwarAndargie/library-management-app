...
import { Search, FileText, LayoutGrid, List, Plus } from 'lucide-react';
    ...
    useEffect(() => {
        const fetchMedia = async () => {
            try {
                ...
                if (!data.error) {
                    setMedia(data.filter(item => item.type === 'pdf'));
                }
            } catch (err) {
                console.error(err);
            } finally {
                ...
                <div className="p-8">
                    <div className="flex items-center justify-between mb-6">
                        <div>
                            ...
                            <p className="text-zinc-500 text-sm">{filteredMedia.length} documents in your library</p>
                        </div>
