...
import { Search, Video as VideoIcon, LayoutGrid, List, Plus } from 'lucide-react';
                ...
                <div className="p-8">
                    <div className="flex items-center justify-between mb-6">
                        <div>
                            ...
                            <p className="text-zinc-500 text-sm">{filteredMedia.length} videos in your library</p>
                        </div>
                    ...
                    {filteredMedia.length === 0 ? (
                        <div className="py-20 flex flex-col items-center justify-center border-2 border-dashed border-zinc-800 rounded-3xl">
                            ...
                            <h3 className="text-lg font-semibold text-zinc-300">No videos found</h3>
                            <p className="text-zinc-500 text-sm">Upload your first video to get started.</p>
                        </div>
                    ) : (
